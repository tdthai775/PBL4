...
namespace Client.ScreenShare
{
    internal class ScreenSharePipeline : IDisposable
    {
        ...
        public ScreenSharePipeline(UdpStreamSender udpSender, int targetWidth = 1280, int targetHeight = 720, int jpegQuality = 50, int targetFps = 30)
        {
        ...
        public async Task StartAsync(CancellationToken token)
        {
            ...
            while (!token.IsCancellationRequested)
            {
                ...
                catch (Exception) { /* Ignore errors and continue */ }
